        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Manage your financial transactions</p>
            </div>
            <Button 
      ...
      <div className="overflow-hidden">
        {loading ? (
          <div className="flex items-center justify-center py-16">
            ...
            <span className="ml-4 text-gray-600 dark:text-gray-400 font-medium">Loading transactions...</span>
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-16 px-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-center max-w-md">Get started by adding your first transaction or adjust your search filters.</p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50 dark:bg-gray-800 sticky top-0 z-10">
                <tr>
                  <th className="text-left py-4 px-6 font-semibold text-gray-900 dark:text-white text-sm uppercase tracking-wider border-b border-gray-200 dark:border-gray-700">Date</th>
                  <th className="text-left py-4 px-6 font-semibold text-gray-900 dark:text-white text-sm uppercase tracking-wider border-b border-gray-200 dark:border-gray-700">Type</th>
                  <th className="text-left py-4 px-6 font-semibold text-gray-900 dark:text-white text-sm uppercase tracking-wider border-b border-gray-200 dark:border-gray-700">Category</th>
                  <th className="text-left py-4 px-6 font-semibold text-gray-900 dark:text-white text-sm uppercase tracking-wider border-b border-gray-200 dark:border-gray-700">Description</th>
                  <th className="text-right py-4 px-6 font-semibold text-gray-900 dark:text-white text-sm uppercase tracking-wider border-b border-gray-200 dark:border-gray-700">Amount</th>
                </tr>
              </thead>
